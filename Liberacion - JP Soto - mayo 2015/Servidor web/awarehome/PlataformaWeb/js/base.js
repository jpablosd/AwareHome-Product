...
function cargarAlertas(){
    ...
    function myFunction(response) {
        ...
        for(i = 0; i < arr.length; i++) {
            ...
            console.log(arr[i].nombre_sensor);
            console.log(arr[i].simbolo_alerta);
            console.log(arr[i].dato);
            ...
            out += "<li class='collection-item avatar'><i class='mdi-action-assessment circle green'></i><span class='title'>"+arr[i].nombre_alerta+"</span><p>"+arr[i].nombre_sensor+" "+arr[i].simbolo_alerta+" "+arr[i].dato+"<br>"+estado+"</p><a href='#!' class='secondary-content'><i class='mdi-action-grade'></i></a></li>";
            //lista
        }
        //document.getElementById("lista").innerHTML = out;
        //$("#lista").html(out);
