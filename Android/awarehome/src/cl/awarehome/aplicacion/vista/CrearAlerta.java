...
import cl.awarehome.aplicacion.vista.Login.asynclogin;
...
public class CrearAlerta extends Activity {
	...
	CheckBox sensor_temperatura, sensor_humedad;
	Button crear_alerta;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sensor_temperatura = (CheckBox) findViewById(R.id.sensor_temperatura);
		sensor_humedad = (CheckBox) findViewById(R.id.sensor_humedad);
