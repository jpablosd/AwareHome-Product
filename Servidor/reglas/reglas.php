...
mysql_query("INSERT INTO regla_basica (sensor_temperatura_humedad_id_sensor_temperatura_humedad, usuario_id_usuario, nombre_regla, sensor, simbolo, dato, fecha, estado) 
			 VALUES ('$sensor_temperatura_humedad_id_sensor_temperatura_humedad', '$usuario_id_usuario', '$nombre_regla', '$sensor', '$simbolo', '$dato', NOW(), '$estado')");
